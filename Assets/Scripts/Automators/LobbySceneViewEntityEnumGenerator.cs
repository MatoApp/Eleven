...
{
    /// <summary>
    /// LobbySceneのViewEntityのEnumを自動生成するクラス
    /// </summary>
    [CreateAssetMenu(
        fileName = "Assets/Automators/LobbySceneViewEntityEnumGenerator.asset",
        menuName = "Automators/Lobby Scene View Entity Enum Generator")]
    internal class LobbySceneViewEntityEnumGenerator : SerializedScriptableObject
    {
        [SerializeField]
        ...
        private void Generate()
        {
            ...
            var names = Resources
                .FindObjectsOfTypeAll(typeof(LobbySceneViewEntityEnumElement))
                .Select(x => x as LobbySceneViewEntityEnumElement)
