...
{
    /// <summary>
    /// GameSceneのViewEntityのEnumを自動生成するクラス
    /// </summary>
    [CreateAssetMenu(
        fileName = "Assets/Automators/GameSceneViewEntityEnumGenerator.asset",
        menuName = "Automators/Game Scene View Entity Enum Generator")]
    internal class GameSceneViewEntityEnumGenerator : SerializedScriptableObject
    {
        [SerializeField]
        ...
        private void Generate()
        {
            ...
            var names = Resources
                .FindObjectsOfTypeAll(typeof(GameSceneViewEntityEnumElement))
                .Select(x => x as GameSceneViewEntityEnumElement)
